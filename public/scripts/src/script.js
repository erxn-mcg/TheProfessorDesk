        ...
        */
        ...
        function createCourse(course) {
            var newCourse = $(emptyCourseTemplate),
                title = course.title === "" ? "Unnamed Student" : course.title,
                code = course.code === "" ? "Student ID" : course.code;
            ...
            "<div class='course-item'>" + 
                "<div class='content-container'>" + 
                    ...
                    "<div class='button-group'>" +
                        "<span class='add-assessment button button-charcoal'><i class='fa fa-plus-circle'></i> New Assignment</span> " +
                        "<span class='course-summary button button-charcoal'><i class='fa fa-bar-chart-o'></i> Student Summary</span> " +
                        "<span class='delete-course button button-red' title='Delete Student'><i class='fa fa-trash-o fa-lg'></i></span>" +
                    "</div>" +
